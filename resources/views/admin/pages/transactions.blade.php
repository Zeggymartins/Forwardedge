                ...
                <tbody>
                    @forelse($transactions as $txn)
                        <tr class="table-row-hover">
                            <td class="fw-semibold py-3 px-4">{{ $txn->id }}</td>
                            <td class="py-3 px-4">
                            ...
                            <td class="py-3 px-4">
                                <span class="badge bg-light text-dark border px-3 py-2">
                                    {{ class_basename($txn->payable_type) }} #{{ $txn->payable_id }}
                                </span>
                            </td>
                            ...
                            <td class="py-3 px-4">{{ $txn->created_at->format('M d, Y H:i') }}</td>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card border-0 shadow-sm rounded-3">
                                                    <div class="card-body">
                                                        ...
                                                        <small class="text-muted">ID: {{ $txn->payable_id }}</small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="card border-0 shadow-sm rounded-3">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="fs-5 text-success">₦{{ number_format($txn->amount,2) }}</p>
                                                        <span class="badge bg-{{ $txn->status == 'successful' ? 'success' : ($txn->status == 'pending' ? 'warning text-dark' : 'danger') }}">
                                                            {{ ucfirst($txn->status) }}
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card border-0 shadow-sm rounded-3">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="mb-1"><strong>Method:</strong> {{ $txn->method ?? '-' }}</p>
                                                        <p class="mb-1"><strong>Reference:</strong> {{ $txn->reference }}</p>
                                                        <p class="mb-0"><strong>Currency:</strong> {{ $txn->currency }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            @if($txn->metadata)
