    ...
    <form method="POST" action="{{ route('login') }}" class="auth-form" id="loginForm">
        ...
        <div class="auth-field">
            ...
            <div class="input-icon-wrapper">
                ...
                <x-text-input id="password" class="pl-10 pr-10" type="password" name="password" required autocomplete="current-password" placeholder="Enter your password" />
                <button type="button" class="password-toggle" onclick="togglePassword()">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="eye-icon" id="eyeIcon">
        ...
        <x-primary-button class="w-full" id="loginButton">
            <span id="buttonText">{{ __('Sign in') }}</span>
            <svg id="buttonSpinner" class="button-spinner hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
