...
@push('styles')
    <style>
        ...
        :root {
            --tj-color-primary: #007bff;
            /* Blue */
            --tj-color-secondary: #0056b3;
            /* Darker Blue */
                    ...
                    <div class="post-details-wrapper">
                                ...
                                @foreach ($event->contents as $content)
                                    ...
                                    @elseif($content->type === 'feature')
                                        ...
                                        @php
                                            ...
                                            $isFeatureWrapOpen =
                                                $loop->first || $event->contents[$loop->index - 1]->type !== 'feature';
                                            $isFeatureWrapClose =
                                                $loop->last || $event->contents[$loop->index + 1]->type !== 'feature';
                                        @endphp
                                        ...
                                        <div class="col-xl-3 col-md-6 col-sm-6">
                                            <div class="speaker-card wow fadeInUp"
                                                ...
                                                <div class="speaker-info">
                                                    ...
                                                    <span
                                                        class="speaker-title">{{ $speaker->tagline ?? ($speaker->title ?? 'Expert') }}</span>
                                                    @if ($speaker->company)
                        ...
                        <div class="schedule-wrap mb-5">
                            ...
                            @if (isset($event->schedules) && $event->schedules->count())
                                ...
                                @endforeach
                            @else
                                <div class="col-12 text-center text-muted p-4 border rounded">Event schedule will be
                                    published shortly.</div>
                            @endif
                        </div>
                        ...
                        <div class="sponsor-wrap mb-5">
                            ...
                            @if (isset($event->sponsors) && $event->sponsors->count())
                                ...
                                @endforeach
                            @else
                                <div class="col-12 text-center text-muted p-4 border rounded">Interested in sponsoring?
                                    Contact us!</div>
                            @endif
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="tj-main-sidebar slidebar-stickiy">
                    ...
                    <div class="tj-sidebar-widget widget-categories wow fadeInUp" data-wow-delay=".1s">
                        ...
                        @if ($event->venue)
                            <div class="infos-item">
                                <div class="project-icons"> <i class="tji-location-1"></i> </div>
                                <div class="project-text">
                                    <span>Venue</span>
