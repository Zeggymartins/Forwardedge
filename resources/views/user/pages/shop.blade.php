                                ...
                                <div class="col-12">
                                    <div class="empty-wrap">
                                        ...
                                        <svg class="empty-svg" viewBox="0 0 400 260" role="img"
                                            aria-label="New courses coming soon">
                                            <defs>
                                                <linearGradient id="gb2" x1="0" y1="0" x2="1"
                                                    y2="1">
                                                    <stop offset="0%" stop-color="#FDB714" />
                                                    <stop offset="100%" stop-color="#2c99d4" />
                                                </linearGradient>
                                                <linearGradient id="gb2soft" x1="0" y1="0" x2="1"
                                                    y2="1">
                                            ...
                                            <ellipse cx="200" cy="170" rx="160" ry="70"
                                                fill="url(#gb2soft)" />
                                            <!-- shopping bag -->
                                            <path d="M140 95h120l-12 90H152z" fill="#fff" stroke="url(#gb2)"
                                                stroke-width="3" />
                                            <path d="M170 95a30 30 0 0 1 60 0" fill="none" stroke="url(#gb2)"
                                                stroke-width="3" stroke-linecap="round" />
                                            <circle cx="180" cy="110" r="4" fill="#2c99d4" />
                                            <circle cx="220" cy="110" r="4" fill="#FDB714" />
                                            <!-- stars -->
                                        ...
                                        <p class="empty-text">No items match your filters. Try clearing them or check back
                                            later.</p>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateDisplay() {
            ...
            minSlider.style.background =
                `linear-gradient(to right, #2c99d4 0%, #2c99d4 ${minPercent}%, #ced8e0 ${minPercent}%, #ced8e0 100%)`;
            maxSlider.style.background =
                `linear-gradient(to right, #2c99d4 0%, #2c99d4 ${maxPercent}%, #ced8e0 ${maxPercent}%, #ced8e0 100%)`;
        }
